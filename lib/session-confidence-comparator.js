...
var SessionConfidenceComparator = function () {
  function SessionConfidenceComparator(session, language, utterance, score, callback) {
    _classCallCheck(this, SessionConfidenceComparator);
  ...
  _createClass(SessionConfidenceComparator, [{
    key: 'next',
    value: function next() {
      this.index--;
      if (this.index >= 0) {
  ...
  return SessionConfidenceComparator;
}();

exports.default = SessionConfidenceComparator;
