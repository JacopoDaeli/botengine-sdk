...
var _prompt = require('./prompt/prompt');
...
var DialogCollection = function (_EventEmitter) {
  ...
  function DialogCollection() {
    ...
    _this.middleware = [];
    _this.dialogs = {};
    DialogCollection.systemDialogs[_constants2.default.DialogId.Prompt] = new _prompt2.default();
...
exports.default = DialogCollection;
