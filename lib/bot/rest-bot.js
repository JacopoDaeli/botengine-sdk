...
var RESTBot = function (_DialogCollection) {
  _inherits(RESTBot, _DialogCollection);

  function RESTBot(options) {
    _classCallCheck(this, RESTBot);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RESTBot).call(this));
          ...
          (function () {
            ...
            req.on('end', function () {
              try {
                ...
                console.error(e);
                _this3.emit('error', new Error('Invalid message'));
                res.send(400);
              }
            });
          })();
      ...
      try {
        var _ret2 = function () {
          if (!message || !message.type) {
            _this4.emit('error', new Error('Invalid message'));
            return {
              v: res ? res.send(400) : null
            };
          }
          if (!userId) {
          ...
          if (message.type === 'Message') {
            (function () {
              ...
              ses.on('error', function (err) {
                ...
                _this4.emit('error', err, ses.message);
...
exports.default = RESTBot;
//# sourceMappingURL=rest-bot.js.map
